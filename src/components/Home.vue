...
//VueCookies.set('name' , authStore.user.id, "3h");
...
<div class="starter-template" align="center">
        <h1 style="font-size:50px;">Prueba Enlaces estrategicos</h1>
        <p class="lead">Para publicar un post haga dar clic en el boton de ingresar.<br> Si no esta registrado haga clic en registrar para crear su post.</p>
<br><br>
        <img src="https://media.licdn.com/dms/image/C4D0BAQHYxBcoorifsQ/company-logo_200_200/0/1540516377189?e=1689811200&v=beta&t=oyNPJmtGJ0ttws5n1FFfQ9mBJxD13zbIEHcFMc_Hxs8" alt="Girl in a jacket" width="250" height="300">
      </div>
